...
export function Header() {
    ...
    return (
        <header className="w-full">
            <div
                className="fixed top-0 left-0 w-full bg-black text-white text-sm py-2 z-50"
            ...
            <nav
                className={`w-full z-40 transition-colors duration-300 ${isScrolled ? 'fixed top-[40px] bg-tap shadow-md' : 'relative bg-background border-b border-border'
                    }`}
